...
/**
 * This class contains a block number and all the instructions belong to that
 * basic block. It serves as the foundation of a CFG.
 * 
 */
public class BasicBlock {
	...
	/**
	 * Initializes the instructions array. Set exitNode as default false
	 */
	public BasicBlock() {
	 ...
	 * 
	 * @param index
	 *            Insturction index of split point
	...
	/**
	 * Returns a string representation: *** Block number: [block_no] *** head:
	 * [instructions[0]] ... [instructions[n]]
	 */
	public String toString() {
		if (instructions.size() > 0) {
			StringBuilder ret = new StringBuilder("*** Block number: "
					+ block_no + " ***\nhead: ");
